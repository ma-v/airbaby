...
puts "Seeding babies"
Baby.destroy_all
baby1 = Baby.new(first_name: "Franck", title: "Dumb baby", age: "2", gender: "other?", description: "Franck is dumb but we like him", price_per_day: 12, clean: false, sleepy: true, excited: false, crying: true, fat: true, playful: true, funny: true, public: true, animals: false, speaks: true, user_id: 2)
...
baby2 = Baby.new(first_name: "Joachim", title: "Cute baby", age: "3", gender: "girl", description: "Jojo is cool", price_per_day: 32, clean: false, sleepy: true, excited: false, crying: true, fat: false, playful: true, funny: true, public: true, animals: false, speaks: true, user_id: 2)
baby2.remote_photo_url = "https://besthairlooks.com/wp-content/uploads/2019/06/fauxhawk-baby-boy.jpg"
baby3 = Baby.new(first_name: "Jerem", title: "GetsChomp baby", age: "1", gender: "boy", description: "Jerem Bo$$", price_per_day: 25, clean: false, sleepy: true, excited: false, crying: true, fat: false, playful: true, funny: true, public: true, animals: false, speaks: true, user_id: 1)
baby3.remote_photo_url = "https://images-na.ssl-images-amazon.com/images/I/41dw2kqRnZL._SX425_.jpg"
baby4 = Baby.new(first_name: "Ronald", title: "Ginger baby", age: "2", gender: "boy", description: "A baby with no soul", price_per_day: 32, clean: false, sleepy: true, excited: false, crying: true, fat: false, playful: true, funny: true, public: true, animals: false, speaks: true, user_id: 3)
baby4.remote_photo_url = "https://meanwhileinireland.com/wp-content/uploads/2016/01/ugly-baby.jpg"
baby5 = Baby.new(first_name: "Chloé", title: "Fitness baby", age: "1", gender: "girl", description: "cutie girl who does 20 push-up every day", price_per_day: 19, clean: true, sleepy: false, excited: true, crying: true, fat: false, playful: true, funny: true, public: true, animals: false, speaks: true, user_id: 3)
baby5.remote_photo_url = "https://t4.ftcdn.net/jpg/00/86/50/91/240_F_86509102_4Uq70BNn0Ehb0XtLs4fy6XZahS9jQAPK.jpg"
baby6 = Baby.new(first_name: "Lola", title: "Princess baby", age: "0", gender: "girl", description: "Meet this little princess, so cute", price_per_day: 38, clean: false, sleepy: true, excited: false, crying: true, fat: false, playful: true, funny: true, public: true, animals: false, speaks: true, user_id: 6)
...
baby7 = Baby.new(first_name: "Diams", title: "Cool baby", age: "1", gender: "girl", description: "She's cool and she knows it", price_per_day: 31, clean: true, sleepy: true, excited: false, crying: false, fat: false, playful: true, funny: true, public: true, animals: true, speaks: true, user_id: 7)
baby7.remote_photo_url = "https://images-na.ssl-images-amazon.com/images/I/81X4TID9IML._SX425_.jpg"
baby8 = Baby.new(first_name: "Leo", title: "Hat baby", age: "3", gender: "boy", description: "A baby wearing a hat, what else?", price_per_day: 36, clean: false, sleepy: true, excited: false, crying: true, fat: false, playful: true, funny: false, public: false, animals: false, speaks: true, user_id: 4)
